        ...
        <div class="flex-center position-ref full-height">
            <div class="content" style="width:100%; padding-top:50px">
                <div class="top-left links">
                  <a href="{{ url('/welcome_corda') }}">Home</a> / <a href="{{ url('/corda') }}" style="font-weight:bold; color:#000">Corda</a>
                </div>
                <div class="top-info">
                ...
                <div class="row" style="padding-top:10px">
                    <img class="card-img-top" src="/images/r3.png" alt="Card image cap">
                </div>
                <div class="title m-b-md row" style="padding-top:0px; margin-top:15px">
                    Corda R3 on Ubuntu Machine
                </div>

                <div class="row" style="padding-top:30px">
                  <div class="col-sm-4">
                    <div class="row" style="">
                      <button class="btn btn-primary" onclick="callNodjs()" disabled><img src="/images/nodejs.png" style="width:35px; margin-right:5px"/> Call Api From NodeJS</button>
                    </div>
                    <div class="row" style="padding-top:30px">
                      <button class="btn btn-primary" onclick="callGolang()" disabled><img src="/images/golang.png" style="width:35px; margin-right:5px"/> Call Api From Golang</button>
                    </div>
                    <div class="row" style="padding-top:30px">
                      <button class="btn btn-primary" onclick="callErlang()" disabled><img src="/images/erlang.png" style="width:35px; margin-right:5px"/> Call Api From Erlang</button>
                    </div>
                    <div class="row" style="padding-top:30px">
                  ...
                  <div class="col-sm-8" style="text-align:left;padding: 0px 50px 0px 20px">
                    <div class="row">
                      <div class="form-group" style="max-width:800px">
                        <label for="label_api_url">Corda Rest Api URL (ex: http://95.179.179.106:8000/api/corda/transactions)</label>
                        <input type="text" class="form-control" id="api_url" name="api_url" placeholder="Enter api url" value="maintaining... Comming soon!" disabled>
                        <small id="url_help" class="form-text">Sorry...  We are updating blockchain now!</small>
                      </div>
